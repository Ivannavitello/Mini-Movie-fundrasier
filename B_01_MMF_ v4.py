...
# profit numbers so tha the winning ticket is excluded )
ticket_won = mini_movie_dict.at[winner_index, 'Total']
profit_won = mini_movie_dict.at[winner_index, 'Profit']
...
mini_movie_string = (mini_movie_dict.to_string(index=False))

total_paid_string = f"Total Paid: ${total_paid:.2f}"
total_profit_string = f"Total Profit: ${total_profit:.2f}"

# winner announcement
luck_winner_string = (f"The lucky winner is {winner}.  "
